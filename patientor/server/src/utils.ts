...
import { DiagnoseEntry, newPatientEntry, Gender, newEntry, HealthType, HealthCheckRating, SickLeave, Discharge, newHealthCheckEntry, newOccupationalHealthcareEntry, newHospitalEntry, newBaseEntry } from './types';
